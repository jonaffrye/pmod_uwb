...
-export([pkt_encapsulation/2,create_iphc_pckt/2,fragment_ipv6_packet/1,reassemble_datagram/2,reassemble_datagrams/1,
        reassemble/2,build_iphc_header/1,get_ipv6_pkt/2,datagram_info/1,compress_ipv6_header/1, build_datagram_pckt/2,
        ...
        binary_to_lis/1, decompress_ipv6_header/2, get_default_LL_add/1, encode_integer/1, tuple_to_bin/1, build_frag_header/1]).
...
%-------------------------------------------------------------------------------
%         General form of Lowpan compression with UDP as nextHeader 
%
%                           1                   2                   3
...
compress_ipv6_header(Ipv6Pckt)->
    ...
    case NextHeader of 
        ?UDP_PN -> 
            ...
            CompressedHeader = <<?IPHC_DHTYPE, TF, NH, HLIM, CID, SAC, SAM, M, DAC, DAM,CarrInlineBin/binary, CompressedUdpHeaderBin/binary>>, 
            {CompressedHeader, CarrInlineMap};
        _ -> 
            CompressedHeader = <<?IPHC_DHTYPE, TF, NH, HLIM, CID, SAC, SAM, M, DAC, DAM,CarrInlineBin/binary>>, 
            {CompressedHeader, CarrInlineMap}
    end.
